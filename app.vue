...
function onsubmit(possibleWords2: string[]) {
  possibleWords.value = possibleWords2;
}
</script>

<template>
  <div
    class="p-4 min-h-screen flex flex-col items-center justify-center"
  ...
  >
    <div>
      ...
      <div class="mt-4 space-y-2 sm:flex sm:items-center sm:justify-center sm:space-y-0 sm:space-x-10 sm:mt-8">
        ...
        >
          ...
          <span class="font-medium">Website Source</span>
        </a>
        ...
        >
          ...
          <span class="font-medium">Dictionary used</span>
        </a>
      </div>
    </div>
    ...
    <div class="mt-10 flex flex-col items-center justify-center gap-8 sm:mt-20 lg:flex-row lg:items-stretch">
      ...
      <WordList
        class="flex-shrink-0 w-full max-w-md min-h-[300px]"
        :words="possibleWords"
      />
    </div>
  </div>
